...
namespace AnyStore.DAL
{
    class productsDAL
    {
        ...
        public DataTable Search(string keywords)
        {
            ...
            try
            {
                string sql = "SELECT * FROM tbl_products WHERE name LIKE '%" + keywords + "%' OR description LIKE '%" + keywords + "%' OR category LIKE '%" + keywords + "%'";
                SqlCommand cmd = new SqlCommand(sql, conn);
                SqlDataAdapter adapter = new SqlDataAdapter(cmd);
                conn.Open();
                adapter.Fill(dt);
        ...
        public productsBLL GetProductIDFromName(string productName)
        {
            ...
            {
                MessageBox.Show("Failed to get product id.  Error: " + ex.Message);
            }
            finally
            {
                conn.Close();
